...
# ritik
ritik_image= face_recognition.load_image_file("/Users/adityajyoti/Documents/Python/project/face-recongnition/face/ritik2.jpg")
ritik_encoding= face_recognition.face_encodings(ritik_image)[0]
# mummy
mummy_image= face_recognition.load_image_file("/Users/adityajyoti/Documents/Python/project/face-recongnition/face/mummy.jpeg")
mummy_encoding= face_recognition.face_encodings(mummy_image)[0]
# papa
papa_image= face_recognition.load_image_file("/Users/adityajyoti/Documents/Python/project/face-recongnition/face/papa.jpeg")
papa_encoding= face_recognition.face_encodings(papa_image)[0]

known_face_encodings = [aditya_encoding, mummy_encoding, papa_encoding, ritik_encoding]
known_face_names = ['Aditya Jytoi', 'mummy', "papa", "Ritik"]
